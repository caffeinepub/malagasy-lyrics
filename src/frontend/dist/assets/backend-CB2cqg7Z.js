...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, v as utf8ToBytes, E as ExternalError, w as MissingRootKeyErrorCode, C as Certificate, x as lookupResultToBuffer, y as RequestStatusResponseStatus, U as UnknownError, z as RequestStatusDoneNoReplyErrorCode, A as RejectError, D as CertifiedRejectErrorCode, F as UNREACHABLE_ERROR, I as InputError, G as InvalidReadStateRequestErrorCode, H as ReadRequestType, J as Principal, K as IDL, N as MissingCanisterIdErrorCode, O as HttpAgent, Q as encode, V as QueryResponseStatus, W as UncertifiedRejectErrorCode, Y as isV3ResponseBody, Z as isV2ResponseBody, _ as UncertifiedRejectUpdateErrorCode, $ as UnexpectedErrorCode, a0 as decode, a1 as Subscribable, a2 as pendingThenable, a3 as resolveEnabled, a4 as shallowEqualObjects, a5 as resolveStaleTime, a6 as noop, a7 as environmentManager, a8 as isValidTimeout, a9 as timeUntilStale, aa as timeoutManager, ab as focusManager, ac as fetchState, ad as replaceData, ae as notifyManager, af as hashKey, ag as getDefaultState, r as reactExports, ah as shouldThrowError, i as useQueryClient, e as useInternetIdentity, ai as createActorWithConfig, aj as Record, ak as Opt, al as Vec, am as Variant, an as Service, ao as Func, ap as Principal$1, aq as Nat, ar as Text, as as Nat8, at as Null, au as Bool, av as Float64, aw as Int } from "./index-CuwG8XZl.js";
...
const TrackInput = Record({
  "title": Text,
  "album": Text,
  "audioFile": ExternalBlob$1,
  "coverImage": ExternalBlob$1,
  "sellerName": Text,
  "artist": Text,
  "priceUSD": Float64
});
...
const MusicSearchParams = Record({
  "sortOrder": Opt(SortOrder),
  "searchText": Opt(Text),
  "artist": Opt(Text)
});
const SortOrder__1 = Variant({
  "mostRecent": Null,
  "alphabetical": Null,
  "mostViewed": Null
});
...
Service({
  ...
  "buildTrackShoppingItem": Func([TrackId], [ShoppingItem], []),
  "createCheckoutSession": Func(
    [Vec(ShoppingItem), Text, Text],
    [Text],
    []
  ),
  "editTrack": Func([TrackId, TrackInput], [], []),
  "getLyric": Func([LyricId], [Opt(LyricEntry)], []),
  "getStripeSessionStatus": Func([Text], [StripeSessionStatus], []),
  "getTrack": Func([TrackId], [Opt(TrackView)], []),
  "isStripeConfigured": Func([], [Bool], ["query"]),
  "listArtists": Func([], [Vec(Text)], ["query"]),
  "listLyrics": Func([], [Vec(LyricEntry)], ["query"]),
  "listPurchases": Func([UserId], [Vec(PurchaseRecord)], ["query"]),
  "listSellerTracks": Func([UserId], [Vec(TrackView)], ["query"]),
  "listTracks": Func(
    [Opt(MusicSearchParams)],
    [Vec(TrackView)],
    ["query"]
  ),
  "publishTrack": Func([TrackInput], [TrackId], []),
  "recordTrackPurchase": Func([Text, TrackId], [], []),
  "republishTrack": Func([TrackId], [], []),
  "searchLyrics": Func([SearchParams], [Vec(LyricEntry)], ["query"]),
  "searchTracks": Func(
    [MusicSearchParams],
    [Vec(TrackView)],
    ["query"]
  ...
  "submitLyric": Func([LyricInput], [LyricId], []),
  "transform": Func(
    [TransformationInput],
    [TransformationOutput],
    ["query"]
  ),
  "unpublishTrack": Func([TrackId], [], []),
  "updateLyric": Func([LyricId, LyricInput], [Bool], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const TrackInput2 = IDL2.Record({
    "title": IDL2.Text,
    "album": IDL2.Text,
    "audioFile": ExternalBlob2,
    "coverImage": ExternalBlob2,
    "sellerName": IDL2.Text,
    "artist": IDL2.Text,
    "priceUSD": IDL2.Float64
  });
  const LyricId2 = IDL2.Nat;
  const UserId2 = IDL2.Principal;
  const Timestamp2 = IDL2.Int;
  const LyricEntry2 = IDL2.Record({
    "id": LyricId2,
    "contributorName": IDL2.Text,
    "yearReleased": IDL2.Nat,
    "title": IDL2.Text,
    "album": IDL2.Text,
    "lyrics": IDL2.Text,
  ...
  const PurchaseRecord2 = IDL2.Record({
    "trackId": TrackId2,
    "buyerId": UserId2,
    "sessionId": IDL2.Text,
    "paidAt": Timestamp2
  ...
  const MusicSearchParams2 = IDL2.Record({
    "sortOrder": IDL2.Opt(SortOrder2),
    "searchText": IDL2.Opt(IDL2.Text),
    "artist": IDL2.Opt(IDL2.Text)
  });
  const SortOrder__12 = IDL2.Variant({
    "mostRecent": IDL2.Null,
    "alphabetical": IDL2.Null,
    "mostViewed": IDL2.Null
  });
  const SearchParams2 = IDL2.Record({
    "yearFilter": IDL2.Opt(IDL2.Nat),
    "artistFilter": IDL2.Opt(IDL2.Text),
    "sortOrder": SortOrder__12,
    "searchText": IDL2.Text
  });
  const StripeConfiguration2 = IDL2.Record({
    "allowedCountries": IDL2.Vec(IDL2.Text),
    "secretKey": IDL2.Text
  });
  const LyricInput2 = IDL2.Record({
    "yearReleased": IDL2.Nat,
    "title": IDL2.Text,
    "album": IDL2.Text,
    "lyrics": IDL2.Text,
  ...
  return IDL2.Service({
    ...
    "buildTrackShoppingItem": IDL2.Func([TrackId2], [ShoppingItem2], []),
    "createCheckoutSession": IDL2.Func(
      [IDL2.Vec(ShoppingItem2), IDL2.Text, IDL2.Text],
      [IDL2.Text],
      []
    ),
    "editTrack": IDL2.Func([TrackId2, TrackInput2], [], []),
    "getLyric": IDL2.Func([LyricId2], [IDL2.Opt(LyricEntry2)], []),
    "getStripeSessionStatus": IDL2.Func([IDL2.Text], [StripeSessionStatus2], []),
    "getTrack": IDL2.Func([TrackId2], [IDL2.Opt(TrackView2)], []),
    "isStripeConfigured": IDL2.Func([], [IDL2.Bool], ["query"]),
    "listArtists": IDL2.Func([], [IDL2.Vec(IDL2.Text)], ["query"]),
    "listLyrics": IDL2.Func([], [IDL2.Vec(LyricEntry2)], ["query"]),
    "listPurchases": IDL2.Func([UserId2], [IDL2.Vec(PurchaseRecord2)], ["query"]),
    "listSellerTracks": IDL2.Func([UserId2], [IDL2.Vec(TrackView2)], ["query"]),
    "listTracks": IDL2.Func(
      [IDL2.Opt(MusicSearchParams2)],
      [IDL2.Vec(TrackView2)],
      ["query"]
    ),
    "publishTrack": IDL2.Func([TrackInput2], [TrackId2], []),
    "recordTrackPurchase": IDL2.Func([IDL2.Text, TrackId2], [], []),
    "republishTrack": IDL2.Func([TrackId2], [], []),
    "searchLyrics": IDL2.Func([SearchParams2], [IDL2.Vec(LyricEntry2)], ["query"]),
    "searchTracks": IDL2.Func(
      [MusicSearchParams2],
      [IDL2.Vec(TrackView2)],
      ["query"]
    ),
    "setStripeConfiguration": IDL2.Func([StripeConfiguration2], [], []),
    "submitLyric": IDL2.Func([LyricInput2], [LyricId2], []),
    "transform": IDL2.Func(
      [TransformationInput2],
      [TransformationOutput2],
      ["query"]
    ),
    "unpublishTrack": IDL2.Func([TrackId2], [], []),
    "updateLyric": IDL2.Func([LyricId2, LyricInput2], [IDL2.Bool], [])
  });
};
...
class Backend {
  ...
  async buildTrackShoppingItem(arg0) {
    if (this.processError) {
      try {
  ...
  async recordTrackPurchase(arg0, arg1) {
    if (this.processError) {
      try {
...
async function from_candid_ExternalBlob_n19(_uploadFile, _downloadFile, value) {
  return await _downloadFile(value);
}
function from_candid_StripeSessionStatus_n12(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n13(_uploadFile, _downloadFile, value);
}
async function from_candid_TrackView_n17(_uploadFile, _downloadFile, value) {
...
function to_candid_MusicSearchParams_n22(_uploadFile, _downloadFile, value) {
  return to_candid_record_n23(_uploadFile, _downloadFile, value);
}
function to_candid_SearchParams_n26(_uploadFile, _downloadFile, value) {
  return to_candid_record_n27(_uploadFile, _downloadFile, value);
}
function to_candid_SortOrder__1_n28(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n29(_uploadFile, _downloadFile, value);
}
function to_candid_SortOrder_n24(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n25(_uploadFile, _downloadFile, value);
}
async function to_candid_TrackInput_n8(_uploadFile, _downloadFile, value) {
