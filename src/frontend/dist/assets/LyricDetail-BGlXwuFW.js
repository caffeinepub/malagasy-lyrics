import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, d as useParams, e as useInternetIdentity, b as Skeleton, L as Link, B as Button, M as Music2, f as ue } from "./index-DTMN0Tcy.js";
import { B as Badge } from "./badge-jGmQiXTI.js";
import { c as useLyric } from "./useLyrics-DeVrJPE2.js";
import { B as BookOpen, S as Share2 } from "./share-2-0z--t04n.js";
import { A as ArrowLeft } from "./arrow-left-Cn1TfJGa.js";
import { P as Pen } from "./pen-ClKJgLRm.js";
import { U as User } from "./user-DJHJbdvo.js";
import { E as Eye } from "./eye-C_ULkJfc.js";
...
function mockViewCount(id2) {
  const seed = Number(id2 % 9999n);
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 w-4/5" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [90, 75, 100, 65, 80].map((w) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-7", style: { width: `${w}%` } }, w)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 pt-4", children: [85, 60, 95, 70].map((w) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-7", style: { width: `${w}%` } }, w)) }),
...
function NotFound() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-muted flex items-center justify-center mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "h-8 w-8 text-muted-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl text-foreground", children: "Song not found" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-sm mx-auto", children: "This lyric may have been removed or the link is no longer valid." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", search: { q: "", genre: "", year: "All" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "mt-2 gap-2", children: [
...
function LyricContent({ lyric, isOwner }) {
  ...
  const stanzas = lyric.lyrics.split(/\n{2,}/).map((s) => s.trim()).filter(Boolean);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", "data-ocid": "lyric-detail", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border-b shadow-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-3 flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-base font-semibold text-foreground truncate", children: lyric.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: lyric.artist })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
        ...
        isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/edit/$id", params: { id: lyric.id.toString() }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            variant: "outline",
            size: "sm",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-10 max-w-3xl space-y-10", children: [
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h1",
              {
                ...
                children: lyric.title
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-x-5 gap-y-1.5 font-body", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
              ...
              lyric.album && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-base text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Music2, { className: "h-3.5 w-3.5 opacity-70" }),
                lyric.album
              ] }),
              lyric.year && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-base text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-3.5 w-3.5 opacity-70" }),
                lyric.year
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
              lyric.genre && /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: "secondary",
                  className: "text-xs tracking-wide uppercase",
                  "data-ocid": "lyric-detail-genre-badge",
                  children: lyric.genre
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Badge,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      background: "linear-gradient(160deg, oklch(0.88 0.055 68) 0%, oklch(0.83 0.045 55) 60%, oklch(0.78 0.04 48) 100%)"
                    },
                    children: stanzas.map((stanza) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "p",
                        {
                          ...
                          children: [
                            "Mpihira:",
                            " ",
                            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "oklch(0.18 0.04 30)" }, children: lyric.artist }),
                            lyric.album && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                              " ",
                              "· Album:",
                              " ",
                              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "oklch(0.18 0.04 30)" }, children: lyric.album })
                            ] })
                          ]
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "p",
                        {
                          ...
                          children: [
                            "Lirik nampidirin'i:",
                            " ",
                            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "oklch(0.18 0.04 30)" }, children: lyric.contributor })
                          ]
                        }
                      )
                    ]
        ...
        motion.section,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground leading-relaxed", children: [
              "Shared by",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: lyric.contributor }),
              " ",
              "on",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: formatDate(lyric.createdAt) })
            ] }),
            lyric.updatedAt !== lyric.createdAt && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              "Last updated ",
...
function LyricDetailPage() {
  const { id: id2 } = useParams({ from: "/lyrics/$id" });
  const lyricId = BigInt(id2);
  ...
  if (!lyric) return /* @__PURE__ */ jsxRuntimeExports.jsx(NotFound, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LyricContent, { lyric, isOwner });
}
export {
  LyricDetailPage
};
