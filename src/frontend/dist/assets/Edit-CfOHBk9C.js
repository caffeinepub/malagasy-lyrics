import { c as createLucideIcon, d as useParams, e as useInternetIdentity, a as useNavigate, r as reactExports, j as jsxRuntimeExports, g as LogIn, B as Button, b as Skeleton, L as Link, f as ue } from "./index-CuwG8XZl.js";
...
import { T as Textarea } from "./textarea-CeZ3g2KQ.js";
import { c as useLyric, e as useUpdateLyric } from "./useLyrics-BcqKs3oa.js";
...
function initFormFromLyric(lyric) {
  ...
  return {
    ...
    artist: lyric.artist,
    album: lyric.album ?? "",
    year: ((_a = lyric.year) == null ? void 0 : _a.toString()) ?? "",
    genre: lyric.genre ?? "",
    lyrics: lyric.lyrics,
    notes: ""
  };
...
function EditPage() {
  ...
  const isAuthorized = Boolean(principalId) && lyric.contributorId === principalId;
  if (!isAuthorized) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
