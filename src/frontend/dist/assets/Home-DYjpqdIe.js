import { c as createLucideIcon, u as useSearch, a as useNavigate, r as reactExports, j as jsxRuntimeExports, S as Search, b as Skeleton, M as Music2, L as Link, B as Button } from "./index-DTMN0Tcy.js";
...
import { u as useLyrics, a as useSearchLyrics, b as useArtists } from "./useLyrics-DeVrJPE2.js";
import { B as BookOpen, S as Share2 } from "./share-2-0z--t04n.js";
import { C as ChevronRight } from "./chevron-right-BZ_9GqK3.js";
    ...
    Link,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-full flex items-center justify-center shrink-0 font-semibold text-xs bg-primary/20 text-primary", children: (lyric.contributor ?? "").charAt(0).toUpperCase() || "?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs truncate flex-1", children: lyric.contributor }),
          lyric.year && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-[10px] shrink-0", children: lyric.year })
        ] })
      ]
    }
  );
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: (lyric.contributor ?? "").charAt(0).toUpperCase() || "?"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs truncate", children: lyric.contributor })
        ] })
      ]
    }
  );
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground leading-snug truncate", children: lyric.title }),
            lyric.genre && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-[10px] shrink-0", children: lyric.genre })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0 space-y-1", children: [
          lyric.year && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: lyric.year }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-muted-foreground justify-end", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: 100 + Number(lyric.id % 900n) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate max-w-[100px]", children: lyric.contributor })
        ] })
      ]
    }
  );
...
function HomePage() {
  ...
  const { data: searchResultsRaw, isLoading: isSearchLoading } = useSearchLyrics({
    query: localQ,
    artist: void 0,
    genre: activeGenre !== "All" ? activeGenre : void 0,
    sortOrder: sortOrder === "newest" ? { __kind__: "Newest" } : sortOrder === "oldest" ? { __kind__: "Oldest" } : { __kind__: "Alphabetical" }
  });
  ...
  const displayLyrics = selectedYear === "All" ? rawResults : rawResults.filter((l) => {
    ...
    if (selectedYear === "2000s") return l.year >= 2e3 && l.year < 2010;
    if (selectedYear === "1990s") return l.year >= 1990 && l.year < 2e3;
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-[1fr_320px] gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
            ...
            isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: ["a", "b", "c", "d", "e", "f"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-40 rounded-xl" }, k)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: (allLyrics ?? []).map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(LyricCardCompact, { lyric: l }, l.id.toString())) })
          ] })
        ] }),
