import { c as createLucideIcon, u as useSearch, a as useNavigate, r as reactExports, j as jsxRuntimeExports, S as Search, b as Skeleton, L as Link, B as Button, k as ShoppingBag } from "./index-BA6E-qdy.js";
...
import { u as useTracks } from "./useMusic-C85e5Vov.js";
...
function StorePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-8", children: [
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5", children: (tracks ?? []).map((track) => /* @__PURE__ */ jsxRuntimeExports.jsx(TrackCard, { track }, track.id.toString())) })
  ] });
}
export {
  StorePage
