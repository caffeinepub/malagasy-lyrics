import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, d as useParams, e as useInternetIdentity, b as Skeleton, L as Link, B as Button, M as Music2, f as ue } from "./index-BA6E-qdy.js";
import { B as Badge } from "./badge-DUAmyM7M.js";
import { c as useLyric } from "./useLyrics-oYIyiOnT.js";
...
import { U as User } from "./user-BMjuqH6e.js";
...
function formatViews(n) {
  const num = Number(n);
  return num >= 1e3 ? `${(num / 1e3).toFixed(1)}k` : String(num);
}
        ...
        motion.header,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-x-5 gap-y-1.5 font-body", children: [
              ...
              lyric.yearReleased > 0n && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-base text-muted-foreground", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "p",
                        {
                          ...
                          children: [
                            "Lirik nampidirin'i:",
                            " ",
                            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "oklch(0.18 0.04 30)" }, children: lyric.contributorName })
                          ]
                        }
                      )
                    ]
        ...
        motion.section,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground leading-relaxed", children: [
              "Shared by",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: lyric.contributorName }),
              " ",
              "on",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: formatDate(lyric.submittedAt) })
            ] }),
            lyric.notes && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1 italic", children: lyric.notes })
          ]
        }
      )
    ] })
